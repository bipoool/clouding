...
func (h *HostGroupController) UpdateHostGroup(c *gin.Context) {
	...
	c.JSON(http.StatusOK, utils.NewSuccessResponse("Host group updated successfully"))
}
...
func (h *HostGroupController) DeleteHostGroup(c *gin.Context) {
	...
	c.JSON(http.StatusOK, utils.NewSuccessResponse("Host group deleted successfully"))
}
